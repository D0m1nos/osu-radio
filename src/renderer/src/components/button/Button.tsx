...
const buttonStyles = cva(
  [
    "rounded-lg transition-colors duration-200 ease font-medium disabled:opacity-50 disabled:cursor-not-allowed",
  ],
  {
    variants: {
      variant: {
        primary: "bg-text text-thick-material hover:bg-text/80 disabled:hover:bg-text",
